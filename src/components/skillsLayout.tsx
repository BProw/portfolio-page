...
import { skillsIcons }from '../assets/images/images'

export const SkillsLayout: React.FC = () => {
  return (
    <section className="base-container-height">
      <div className="w-2/3 h-full m-auto bg-white -mt-32 rounded-lg">
        <div className="flex flex-row justify-evenly">
          <div className="flex flex-col mt-16">
            <h3 className="text-center font-bold text-xl">Languages | Frameworks</h3>
            <img src={skillsIcons.code} alt="Code icon" className="h-16 w-16 m-auto my-10" />
          ...
          <div className="flex flex-col mt-16">
            <h3 className="text-center font-bold text-xl">Developer</h3>
            <img src={skillsIcons.repair} alt="Web develpment icon" className="h-16 w-16 m-auto my-10" />
          ...
          <div className="flex flex-col mt-16">
            <h3 className="text-center font-bold text-xl">Background</h3>
            <img src={skillsIcons.experience} alt="Experience icon" className="h-16 w-16 m-auto my-10" />
